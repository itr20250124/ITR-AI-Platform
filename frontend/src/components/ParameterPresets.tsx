...
export const ParameterPresets: React.FC<ParameterPresetsProps> = ({
  ...
  return (
    <>
        ...
        <CardContent>
          {presets.length === 0 ? (
            <div className='text-center py-8 text-gray-500 dark:text-gray-400'>
              ...
              <p>還沒有保存的參數預設值</p>
              <p className='text-sm mt-2'>調整參數後點擊「保存預設值」來創建第一個預設值</p>
            </div>
          ) : (
                  ...
                  <div className='flex items-center justify-between'>
                    <div className='flex-1'>
                      ...
                      <div className='flex items-center space-x-4 mt-2 text-xs text-gray-500 dark:text-gray-400'>
                        <span>{Object.keys(preset.parameters).length} 個參數</span>
      ...
      {/* 保存預設值對話框 */}
      <Modal isOpen={showSaveModal} onClose={() => setShowSaveModal(false)} title='保存參數預設值'>
        <ModalContent>
