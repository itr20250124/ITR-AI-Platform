...
describe('ParameterInput', () => {
  ...
  describe('Select Input', () => {
    ...
    it('should render select input correctly', () => {
      render(
        <ParameterInput definition={selectDefinition} value='gpt-4' onChange={mockOnChange} />
      );
  ...
  describe('Boolean Input', () => {
    ...
    it('should render boolean input correctly', () => {
      render(
        <ParameterInput definition={booleanDefinition} value={true} onChange={mockOnChange} />
      );
  ...
  describe('String Input', () => {
    ...
    it('should call onChange when text changes', () => {
      render(
        <ParameterInput definition={stringDefinition} value='Hello' onChange={mockOnChange} />
      );
