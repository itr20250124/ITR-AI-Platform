...
describe('ParameterInput', () => {
  ...
  describe('Number Input', () => {
    ...
    it('should render number input correctly', () => {
      render(<ParameterInput definition={numberDefinition} value={0.8} onChange={mockOnChange} />)
    ...
    it('should call onChange when value changes', () => {
      render(<ParameterInput definition={numberDefinition} value={0.7} onChange={mockOnChange} />)
    ...
    it('should show default value when no value provided', () => {
      render(
        <ParameterInput definition={numberDefinition} value={undefined} onChange={mockOnChange} />
      )
  ...
  describe('Select Input', () => {
    ...
    it('should render select input correctly', () => {
      render(<ParameterInput definition={selectDefinition} value='gpt-4' onChange={mockOnChange} />)
  ...
  describe('Boolean Input', () => {
    ...
    it('should render boolean input correctly', () => {
      render(<ParameterInput definition={booleanDefinition} value={true} onChange={mockOnChange} />)
    ...
    it('should call onChange when checkbox changes', () => {
      render(
        <ParameterInput definition={booleanDefinition} value={false} onChange={mockOnChange} />
      )
  ...
  describe('String Input', () => {
    ...
    it('should render string input correctly', () => {
      render(
        <ParameterInput definition={stringDefinition} value='Hello world' onChange={mockOnChange} />
      )
    ...
    it('should call onChange when text changes', () => {
      render(<ParameterInput definition={stringDefinition} value='Hello' onChange={mockOnChange} />)
  ...
  describe('Default Value Display', () => {
    it('should show default value in label', () => {
      ...
      render(<ParameterInput definition={definition} value={0.8} onChange={mockOnChange} />)
