...
describe('ChatMessage', () => {
  ...
  describe('Assistant Message', () => {
    ...
    it('should show regenerate button for assistant messages', () => {
      ...
      render(<ChatMessage message={mockAssistantMessage} onRegenerate={mockOnRegenerate} />)

      const messageElement = screen
        .getByText('I am doing well, thank you for asking!')
        .closest('.flex')
      fireEvent.mouseEnter(messageElement!)
  ...
  describe('Streaming Message', () => {
    ...
    it('should show stop button when streaming', () => {
      ...
      render(<ChatMessage message={mockAssistantMessage} isStreaming={true} onStop={mockOnStop} />)
    ...
    it('should have pulsing animation when streaming', () => {
      const { container } = render(
        <ChatMessage message={mockAssistantMessage} isStreaming={true} />
      )
