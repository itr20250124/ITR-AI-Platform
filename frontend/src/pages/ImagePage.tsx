    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="fixed bottom-4 left-4 bg-black bg-opacity-75 text-white text-xs px-3 py-2 rounded-lg opacity-0 hover:opacity-100 transition-opacity">
        <div className="space-y-1">
          <div><kbd className="bg-gray-700 px-1 rounded">G</kbd> 圖片生成</div>
          <div><kbd className="bg-gray-700 px-1 rounded">E</kbd> 圖片編輯</div>
          <div><kbd className="bg-gray-700 px-1 rounded">H</kbd> 圖片歷史</div>
        </div>
      </div>
    </div>
  );
...
// 添加鍵盤快捷鍵支持
export const useImagePageKeyboard = (setActiveTab: (tab: 'generate' | 'edit' | 'history') => void) => {
  React.useEffect(() => {
